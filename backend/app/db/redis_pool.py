...
def get_redis_client():
    ...
    Returning None forces the application to operate in MySQL-only mode.
    """
    # logger.warning("Redis cache layer is disabled by configuration, operating in MySQL-only mode")
    
    # Old Redis implementation commented out for now:
