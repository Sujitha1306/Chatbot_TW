...
export class AssetTrackComponent implements  OnDestroy {
  ...
  MTDisplayedColumns: string[] = ['Asset ID', 'Asset Name', 'Alerts', 'Driver Name', 'Mobile No', 'Tag ID'];
  ...
  assignDriver(data) {
    data['associateAction'] = 'asset-track';
