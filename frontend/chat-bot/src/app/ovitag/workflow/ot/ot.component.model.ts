...
export class DigitalQueueModel {
  constructor(
      public DQ_CA: boolean = true, 
      public DQ_LA: boolean = true, 
      public DQ_CN: boolean = true, 
      public DQ_SP: boolean = true, 
      public DQ_WA: boolean = true, 
      public DQ_IP: boolean = true, 
      public DQ_CO: boolean = true, 
